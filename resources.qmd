...
- [Deaf Culture That](https://deafculturethat.com/). By Thomas K. Holcomb and Anna Mindess.
...
- [Metropolitian Asian Deaf Association](https://madanyc.org/).
  + NY-based social club-turned-advocacy organization.
  + Is gonna host the [Deaf Asian Street Festival](https://madanyc.org/dasf/).
...
- [Handspeak](https://www.handspeak.com/). By Jolanta Lapiak.
  ...
  + Offers [fingerspelling receptive practice](https://www.handspeak.com/learn/413/) and [number receptive practice](https://www.handspeak.com/learn/23/) videos.
...
- _The Gallaudet Children's Dictionary of American Sign Language_. By GU editors and illustrators. Published 2014. :bug:
  ...
  + Has a [companion website](https://gcdasl.com/) with [sentences](https://gcdasl.com/sentences/).
...
- [CBC Kids ASL Collection](https://gem.cbc.ca/collection/cbc-kids-asl-collection).
  + Consists of _Silly Paws_ and two other ASL shows: one about dinosaurs and the other, bizarrely, about music.
...
- [PBS Kids: Episodes in ASL](https://pbskids.org/videos/american-sign-language-full-episodes).
...
- [Atomic Hands](https://atomichands.com/). By Dr. Alicia Wooten and Dr. Barbara Spiecker.
  + Scientific topics in ASL, mostly at the secondary school level and below.
  + See the [STEM storybooks](https://atomichands.com/asl-stem-storybooks/), [STEM videos](https://atomichands.com/videos/), and [corresponding YouTube channel](https://www.youtube.com/@atomichands).
...
- [Treehouse Video](https://treehousevideo.com).
  + See Holcomb's series on [Deaf Centered Interpreting](https://store.treehousevideo.com/vlog-series/). Alternative link: [YouTube channel](https://www.youtube.com/channel/UC2oojDaSCYfZ31LHCGKUe2Q).
  + Lessard's series on classifiers: [Classifers, a Closer Look](https://store.treehousevideo.com/product/classifiers-full-curriculum/).
...
- [Minimal Pairs in ASL](https://www.handspeak.com/learn/109/). By Jolanta Lapiak.
  + Minimal pairs are a set of words that differ only by one phoneme. In sign languages, a minimal pair differs by one [parameter](https://www.handspeak.com/learn/397/).
...
- [Lansing Community College Library Research Guide: Sign Language](https://libguides.lcc.edu/signlanguage).
  + Lots of suggested resources, including [receptive and expressive practice](https://libguides.lcc.edu/c.php?g=167870&p=10411180).
