...
- There's WHO, WHAT, WHERE, WHEN, WHY, and HOW. Those are straightforward. I wonder if I [use them too often](https://youtu.be/c-tT_VWfyNU).
- Also FOR-FOR, though I'm not sure when to use FOR-FOR versus FOR WHAT.
